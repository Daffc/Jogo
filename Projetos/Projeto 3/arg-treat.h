...
void tratamento_simples(int *argc, char **,  char * , int , char **in, char **out,int *time, float *level );
...
void tratamento_multiplo(int *, char **, char * , int qnt_params, char *in[], int *qnt_entradas, char **out);
#endif
